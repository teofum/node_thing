...
function buttonClassnames(
  ...
  return cn(
    ...
    "aria-[disabled]:text-white/40 aria-[disabled]:cursor-default",
    {
      ...
      "hover:bg-current/10 aria-[disabled]:hover:bg-transparent active:bg-current/15 aria-[disabled]:active:bg-transparent":
