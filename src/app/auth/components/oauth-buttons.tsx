  ...
  return (
    <div className="space-y-2">
      <button
        ...
        disabled={isLoading}
        className="w-full p-2 border border-gray-300 rounded flex items-center justify-center gap-2 hover:bg-gray-50 disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
      >
